    ...
    <main className="plan-page"><div className="plan-shell">
      ...
      <section className="plan-pricing">
        ...
        <div className="launch-pricing-grid">
          ...
          <article className="launch-price-card featured"><div className="price-kicker">My recommendation.</div><h3>Build + Check-Ins</h3><div className="launch-price"><span>$229</span><strong>$149</strong></div><ul><li><Check size={15}/>Everything in The Build</li><li><Check size={15}/>Four structured weekly check-ins</li><li><Check size={15}/>Written feedback + adjustment review</li></ul><form action="/api/checkout" method="post"><input type="hidden" name="plan" value="guided"/><input type="hidden" name="email" value={fit.email}/><button className="button-primary" type="submit">Choose guided <ArrowRight size={15}/></button></form></article>

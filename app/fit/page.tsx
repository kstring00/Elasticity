...
const screens = [
  ...
  { key: 'pain', title: 'Anything hurting right now?', helper: 'This is a context question so Abrielle can understand what you need before talking with you. It is not a diagnosis.', options: ['No','Minor, and I know how to manage it','Yes, but I have been evaluated and cleared','Yes, and I have not had it evaluated'] },
] as const
...
export default function FitPage() {
  ...
  return (
    <main className="fit-page"><div className="fit-shell">
      ...
      {step === -1 && <section className="fit-card fit-intro"><div className="eyebrow">A quick fit check · about 90 seconds</div><h1>Let's find the kind of support that fits your body right now.</h1><p>Five tap questions, then your name and email. No card. No essay. Your answers give Abrielle context so she can understand what may fit you before you decide what comes next.</p><button className="button-primary" onClick={() => setStep(0)}>Begin <ArrowRight size={15}/></button></section>}
